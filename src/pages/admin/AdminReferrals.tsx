  ...
  const { data: referrals, isLoading: referralsLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from('referrals')
        .select('id, referrer_id, referred_user_id, referral_code, referred_email, status, reward_type, reward_claimed, reward_claimed_at, created_at, converted_at, expires_at')
