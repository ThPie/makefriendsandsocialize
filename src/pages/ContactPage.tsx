      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 px-4 w-full max-w-6xl mx-auto mb-20">
        ...
        >
          ...
          >
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem
                  key={index}
                  value={`item-${index}`}
                  className="group bg-card border border-border/50 rounded-2xl px-5 data-[state=open]:border-primary/30"
                >
            ...
            <motion.div
              variants={itemVariants}
              className="bg-card border border-border/50 rounded-2xl p-5 hover-lift mt-4"
            >
