            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-background px-3 text-muted-foreground text-xs">Or {mode === 'signin' ? 'login' : 'register'} with</span>
                </div>
              </div>
          ...
          <div className="flex-1 px-6 py-6 -mt-8 relative z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="relative my-4">
                <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-border" /></div>
                <div className="relative flex justify-center text-sm"><span className="bg-background px-3 text-muted-foreground text-xs">or</span></div>
              </div>
