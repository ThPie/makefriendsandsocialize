  ...
  const benefits = [
    {
      ...
      description:
        "Intimate events designed to foster genuine connection and brotherhood.",
    },
    {
      icon: MessageCircle,
    ...
    },
    {
      ...
      description:
        "Connect with driven men across industries in a supportive setting.",
    },
    {
      icon: Heart,
      title: "Wellness & Performance",
      description:
        "Curated wellness experiences — from fitness challenges to mindfulness sessions.",
    },
    {
      icon: Star,
    ...
    {
      icon: Gem,
      title: "Annual Brotherhood Dinner",
      description:
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center overflow-hidden">
          ...
          >
            ...
            >
              A private space for men who seek growth, accountability, and
              brotherhood — without ego or competition. Just men lifting each
              other higher.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed max-w-3xl mx-auto mb-4">
                We believe strength is built through connection, not isolation.
                The Gentlemen exists to bring together men who are committed to
                personal growth, honest conversations, and showing up for one
                another — consistently and without pretense.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed max-w-3xl mx-auto">
                This is a space where ambition is encouraged, vulnerability is
                respected, and every man leaves stronger than he arrived.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground text-lg mb-8 max-w-lg mx-auto">
                Your membership gives you access to The Gentlemen circle and all
