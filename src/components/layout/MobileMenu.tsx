...
import { X, Menu, Home, Calendar, Users, Heart, Newspaper, Mail, HelpCircle, ChevronDown, Instagram, Facebook, Linkedin, Compass, Brain } from 'lucide-react';
...
const navLinks = [
  ...
  { label: 'Soul Maps', to: '/soul-maps', icon: Brain },
