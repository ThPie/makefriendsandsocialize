...
export const AvailabilitySection = () => {
    return (
        <section className="w-full px-6 py-24 bg-[#0a0f0a] flex justify-center">
            <div className="max-w-md w-full p-12 rounded-2xl bg-[#141f17] border border-white/5 text-center relative overflow-hidden group hover:bg-[#141f17]/80 transition-colors duration-500 shadow-2xl">
